...
public class JhblogApp {

    private static final Logger log = LoggerFactory.getLogger(JhblogApp.class);

    private final Environment env;

    public JhblogApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhblogApp.class);
