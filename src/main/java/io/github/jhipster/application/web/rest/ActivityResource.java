...
public class ActivityResource {
    ...
    /**
     * GET  /activities/:wechatUserId : get the "wechatUserId" activity.
     *
     ...
     */
    @GetMapping("/activities/{wechatUserId}")
    @Timed
    public List<ActivityDTO> getActivityByWechatUserId(@PathVariable String wechatUserId) {
        log.debug("REST request to get Activity : {}", wechatUserId);
        return activityService.findOneByWechatUserId(wechatUserId);
    }
